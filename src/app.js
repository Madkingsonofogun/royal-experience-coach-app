    ...
    <section class="workspace">
      ...
      <div class="split">
        ...
        <article class="card admin-card" id="admin-exercise-library-new">
          ...
          <button class="success full" id="adminImportExcel">Import Excel Starter Library</button>
...
function bindGlobal() {
  ...
  document.querySelector("#adminImportExcel")?.addEventListener("click", () => {
    adminImportExercisesFromRows(store, state.currentUser, store.excelStarterRows);
    render();
  });
